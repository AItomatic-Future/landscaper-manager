          ...
          {showEquipmentInfo && (
            <div className="bg-gray-100 p-3 rounded-lg mb-3 text-sm">
              <p className="text-gray-700">
                Equipment Name and Description will be shown in Equipment. Create here ONLY Excavators and Carriers (wheel barrow, petrol barrows and dumpers)
              </p>
            </div>
          )}
