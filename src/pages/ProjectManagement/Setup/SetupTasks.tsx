          ...
          {showTaskInfo && (
            <div className="bg-gray-100 p-3 rounded-lg mb-3 text-sm">
              <p className="text-gray-700">
                Here you will find average time needed for specific tasks (it will fetch information from your workers). On beginning, double check if this standard average time is appropriate for your team! Edit them however you like.
              </p>
            </div>
          )}
